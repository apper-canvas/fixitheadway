import React from 'react'
      ...
      const TaskSection = ({ tasks, setTasks, loading, error, newTask, setNewTask, showTaskForm, setShowTaskForm }) => {
        ...
        const [searchRadius, setSearchRadius] = useState(5) // Local state for search radius
